...
require_relative "../../lib/recommended_link_parser"

class RecommendedLinkParserTest < Test::Unit::TestCase
  test "Can parse a CSV file " do
    fixture_file = File.expand_path("../fixtures/sample-recommended-links.csv", File.dirname(__FILE__))
    recommended_links = RecommendedLinkParser.new(fixture_file).recommended_links
